...
function addEonce() {
    ...
    /*document.getElementById('unitId').addEventListener('mousedown', function (e) {
        isDown = true;
        offset = document.getElementById('unitId').offsetLeft - e.clientX,
            console.log(offset)
    }, true);
    ...
    document.addEventListener('mousemove', function (event) {
        ...
        if (isDown) {
            ...
            console.log(mousePosition.x + offset)
            document.querySelector("iframe").style.width = (mousePosition.x + offset) + 'px';
